...
const Home = () => {
  return (
    <div className="w-full md:h-screen md:overflow-y-scroll md:mx-20 md:scrollbar-thin md:scrollbar-thumb-rounded md:scrollbar-thumb-bg-300 md:scrollbar-track-bg-100">
      <div className="mt-4 px-[2px] mb-16 md:space-y-4 md:px-14">
