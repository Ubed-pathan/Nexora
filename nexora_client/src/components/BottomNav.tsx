...
export default function BottomNav() {
    return (
        <div className="md:hidden fixed bottom-0 left-0 w-full py-2 bg-bg-300 flex items-center justify-evenly">
            ...
            <Link to='/profile' className="w-9 h-9 rounded-full border border-text-100 p-1 flex items-center justify-center"><img src={man} alt="avtar" className="w-full h-full rounded-full" /></Link>
        </div>
    );
}
